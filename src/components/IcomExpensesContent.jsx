...
export default function IcomExpensesContent() {
  ...
  return (
    <div className="bg-white mt-5 w-full">
      <h3 className="text-end mb-4 text-2xl font-medium text-[#4b3164]">
        Income and Expense
      </h3>
      <div className="text-end">
        <h4 className="text-2xl font-medium text-[#919090]">Income</h4>
        <span className="text-lg font-medium text-green-400">
          {positiveNumber}
        </span>
      </div>
      <div className="text-end mt-5">
        <h4 className="text-xl font-medium text-[#919090]">Expense</h4>
